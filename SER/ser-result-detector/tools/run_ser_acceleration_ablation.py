...
METRICS = [
    ...
    "SER_PRED_PR_WR_FORCED_CONSTRAINTS_COUNT",
    "SER_PRED_PR_WR_INITIAL_CANDIDATES_COUNT",
    "SER_PRED_PR_WR_RESIDUAL_CANDIDATES_COUNT",
    "SER_PRED_PR_WR_PRUNED_CANDIDATES_COUNT",
    "SER_PRED_PR_WR_FIXED_CANDIDATES_COUNT",
