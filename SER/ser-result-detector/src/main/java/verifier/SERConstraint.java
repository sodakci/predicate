...
class SERConstraint<KeyType, ValueType> {

    // writeTransaction1 -> writeTransaction2
    @ToString.Include(rank = 1)
    private final Collection<SEREdge<KeyType, ValueType>> edges1;

    // writeTransaction2 -> writeTransaction1
    @ToString.Include(rank = 0)
    private final Collection<SEREdge<KeyType, ValueType>> edges2;
