...
/**
 * 纯单元测试：验证 SIVerifier 中的 predicate 边推导辅助函数。
...
public class SIVerifierPredicateTest {
    ...
    void writeRowIsInPredicateResult_writeValueSatisfiesPredicate() throws Exception {
        ...
        Method m = findMethod(SIVerifier.class, "writeRowIsInPredicateResult",
    ...
    void writeChangesPredicateResultSet_prevEmpty_currHasResult() throws Exception {
        ...
        Method m = findMethod(SIVerifier.class, "writeChangesPredicateResultSet",
    ...
    void uniqueTopologicalSort_linearOrder() throws Exception {
        ...
        Method m = findMethod(SIVerifier.class, "uniqueTopologicalSort",
    ...
    void buildWritesByKey_groupsWritesByKey() throws Exception {
        ...
        Method m = findMethod(SIVerifier.class, "buildWritesByKey",
                KnownGraph.class);
        @SuppressWarnings("unchecked")
